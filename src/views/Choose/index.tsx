        ...
        <ChooseContainer variant="sea">
            <ChooseContainer2>
                ...
                <Link to='/surf' style={{ textDecoration: 'none' }}>
                    ...
                    <ChooseButton>
                        <MdSurfing size={'4rem'} color={'#fff'} style={{ padding: '20px' }} />
                ...
                <Link to='/funcional' style={{ textDecoration: 'none' }}>
                    <ChooseButton>
                        <Img src={func4} style={{ color: '#fff', height: '100px', padding: '20px' }} />
                ...
                <Link to='/muaythai' style={{ textDecoration: 'none' }}>
                    <ChooseButton>
                        <Img src={boxe4} style={{ color: '#fff', height: '100px', padding: '20px' }} />
                        <FontAsH1>Muay-Thai    </FontAsH1>
                        <Img src={boxe4} style={{ color: '#fff', height: '100px', padding: '20px' }} />
                    </ChooseButton>
                </Link>

                <Link to='/voley' style={{ textDecoration: 'none' }}>
                    <ChooseButton>
                        <GiBeachBall size={'4rem'} color={'#fff'} style={{ padding: '20px' }} />
                        <FontAsH1>Volei de Praia         </FontAsH1>
                        <GiBeachBall size={'4rem'} color={'#fff'} style={{ padding: '20px' }} />
                    </ChooseButton>
                </Link>
                ...
                <Link to='/beach' style={{ textDecoration: 'none' }}>
                    <ChooseButton>
                        <Img src={beach4} style={{ color: '#fff', height: '120px', padding: '10px' }} />
