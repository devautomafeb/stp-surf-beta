...
import video01 from '../../assets/videos/VIDEO_MT.mp4';
import { Teacher } from "../../components/Teacher";

import professor01 from '../../assets/images/muayProf.jpg';
...
export function Muaythai() {
    ...
    const textA = 
        <FontAsH3>MUAY THAI: Você quer se sentir mais confiante, saudável e com energia para enfrentar o dia
            ...
            prontos para ajuda-lo a alcançar seus objetivos.</FontAsH3>
